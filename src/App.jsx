  ...
  return (
    ...
    <div className='flex justify-between flex-col lg:flex-row max-w-7xl mx-auto lg:p-4 md:p-3 p-1'>
      ...
      <nav className='flex gap-4 justify-center items-center'>
        ...
        <Link to="/AllProducts" className="font-medium border-b-2 border-b-transparent hover:border-amber-300 transition-all duration-200 flex justify-center">Productos</Link>
